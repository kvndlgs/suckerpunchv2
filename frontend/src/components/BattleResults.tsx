...
export const BattleResults: React.FC<BattleResultsProps> = ({
  ...
  const shareOnTwitter = () => {
    ...
    const url = `https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(battleUrl)}`;
    ...
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 mb-8 text-center"
        >
          <Trophy className="w-16 h-16 text-yellow-400 mx-auto mb-4" />
          <h1 className="text-4xl font-bold text-white mb-2">Battle Complete!</h1>
