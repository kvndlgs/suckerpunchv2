...
exports.getBattleData = void 0;
var supabase_1 = require("../supabase");
var getBattleData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var battleId, _a, battle, error, error_1;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, supabase_1.supabase
                        ...
                        .single()];
            case 2:
                _a = _b.sent(), battle = _a.data, error = _a.error;
                if (error || !battle) {
                    return [2 /*return*/, res.status(404).json({ error: 'Battle not found' })];
                }
                res.json({
                    battle: battle,
                    shareUrl: "".concat(req.headers.host, "/battle/").concat(battleId)
                });
                return [3 /*break*/, 4];
            case 3:
                error_1 = _b.sent();
                console.error('Battle fetch error:', error_1);
...
exports.getBattleData = getBattleData;
